...
class Level():
    def __init__(self, level_data, surface,username, current_level, coins_counter, game_bg):
    ...
    def display_coins_collected(self):
        ...
        self.text = self.font.render(f'  {self.coins_counter + self.coins_counter_old}', False , 'pink')
