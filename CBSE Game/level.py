...
class Level():
    ...
    def display_coins_collected(self):
        ...
        self.coin_icon_image = pygame.image.load(os.path.join('Assets','Images','Coins','coin.png')).convert_alpha()
        self.coin_icon_surface = pygame.transform.scale(self.coin_icon_image,(60 , 60))
        self.coin_icon_rect = self.coin_icon_surface.get_rect(topleft = (550,100))
        self.text_rect = self.text.get_rect(center = (SCREEN_WIDTH//2 , 100))
        self.display_surface.blit(self.text,self.text_rect)
        self.display_surface.blit(self.coin_icon_surface , self.coin_icon_rect)
